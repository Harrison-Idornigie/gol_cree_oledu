...
import { getAllLanguages, getSelectedLanguages, selectLanguage, unselectLanguage } from "@/app/_actions/user/language-actions";
...
export default function LanguagesPage() {
  ...
  const [selectedLanguageDetails, setSelectedLanguageDetails] = useState<Language | null>(null);
  ...
  const filteredLanguages = activeTab === "selected" 
                  ...
                  <CardFooter className="flex justify-between">
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button variant="outline" size="sm" onClick={() => setSelectedLanguageDetails(language)}>
                      ...
                      <DialogContent>
                        ...
                        <div className="space-y-4">
                          <div>
                            <h4 className="mb-1 font-medium">About this language</h4>
                            <p className="text-sm text-muted-foreground">
                              {language.description || `${language.name} is spoken by millions of people around the world. Start your journey to learn this beautiful language today.`}
                            </p>
                          </div>
                          <div>
                            <h4 className="mb-1 font-medium">Learning Content</h4>
                            <p className="text-sm text-muted-foreground">
                              {language.learning_paths_count || 0} learning paths available
                            </p>
                          </div>
                        </div>
                      </DialogContent>
                    ...
                    {isLanguageSelected(language.id) ? (
                      <Button variant="outline" onClick={() => handleUnselectLanguage(language)}>
        ...
        <TabsContent value="selected" className="mt-6">
          {isLoading ? (
            ...
            <div className="py-12 text-center">
              ...
              <h3 className="mb-2 text-lg font-medium">No languages selected</h3>
              <p className="mb-6 text-muted-foreground">
                You haven't selected any languages to learn yet. Browse the available languages and add some to your profile.
              </p>
              <Button onClick={() => setActiveTab("all")}>Browse Languages</Button>
            </div>
          )}
        </TabsContent>
      </Tabs>
