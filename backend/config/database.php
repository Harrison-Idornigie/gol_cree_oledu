    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_CONNECTION') === 'mysql' ? env('DB_DATABASE', 'laravel') : env('MYSQL_DATABASE', 'laravel'),
        ...
        'mariadb' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_CONNECTION') === 'mariadb' ? env('DB_DATABASE', 'laravel') : env('MYSQL_DATABASE', 'laravel'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
        ...
        'pgsql' => [
            ...
            'database' => env('DB_CONNECTION') === 'pgsql' ? env('DB_DATABASE', 'laravel') : env('PGSQL_DATABASE', 'laravel'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
        ...
        'mysql_testing' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'gol_2025_testing'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
